...
plt.plot(range(len(losts)), losts, label='lost')
plt.show()
...
plt.legend()-0.05595223405638377, -0.36787762427358217, -0.022198226052942846, 0.22037728337761453, 0.5166942615739102, 0.3743172059155652, 0.29252042973349845, 0.15761808928854235, -0.03884517706393764, 0.19562706230740287, -0.13250123655516102, -0.24446028797966096, 0.1630915851634984, 0.08278702076496547, 0.05269395691538083, -0.28621244397858236, -0.34248659167294376, 0.07891690924177455, 0.06289140588786497, 0.036076554506985166, -0.19099541446861115
