...
for n in range(100) :
    for i in rangeOfDataKey :
        #求梯度
        #w1
        w1gpart1 = 2 * (w1 * pm25[i] + w2 * pm25[i + 1] + w3 * pm25[i + 2] + w4 * pm25[i + 3] + w5 * pm25[i + 4] + w6 * pm25[i + 5])
        w1gpart2 = -1 * pm25[i]
        w1g += w1gpart1 * w1gpart2
        #w2
        w2gpart1 = 2 * (w1 * pm25[i] + w2 * pm25[i + 1] + w3 * pm25[i + 2] + w4 * pm25[i + 3] + w5 * pm25[i + 4] + w6 * pm25[i + 5])
        w2gpart2 = -1 * pm25[i+1]
        w2g += w2gpart1 * w2gpart2
        #w3
        w3gpart1 = 2 * (w1 * pm25[i] + w2 * pm25[i + 1] + w3 * pm25[i + 2] + w4 * pm25[i + 3] + w5 * pm25[i + 4] + w6 * pm25[i + 5])
        w3gpart2 = -1 * pm25[i+2]
        w3g += w3gpart1 * w3gpart2
        #w4
        w4gpart1 = 2 * (w1 * pm25[i] + w2 * pm25[i + 1] + w3 * pm25[i + 2] + w4 * pm25[i + 3] + w5 * pm25[i + 4] + w6 * pm25[i + 5])
        w4gpart2 = -1 * pm25[i+3]
        w4g += w4gpart1 * w4gpart2
        #w5
        w5gpart1 = 2 * (w1 * pm25[i] + w2 * pm25[i + 1] + w3 * pm25[i + 2] + w4 * pm25[i + 3] + w5 * pm25[i + 4] + w6 * pm25[i + 5])
        w5gpart2 = -1 * pm25[i+4]
        w5g += w5gpart1 * w5gpart2
        #w6
        w6gpart1 = 2 * (w1 * pm25[i] + w2 * pm25[i + 1] + w3 * pm25[i + 2] + w4 * pm25[i + 3] + w5 * pm25[i + 4] + w6 * pm25[i + 5])
        w6gpart2 = -1 * pm25[i+5]
        w6g += w6gpart1 * w6gpart2
        #b
        bgpart1 = 2 * (w1 * pm25[i] + w2 * pm25[i + 1] + w3 * pm25[i + 2] + w4 * pm25[i + 3] + w5 * pm25[i + 4] + w6 * pm25[i + 5])
        bgpart2 = -1
        bg += bgpart1 * bgpart2
